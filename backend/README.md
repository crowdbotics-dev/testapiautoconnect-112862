...
## Project Structure
    ...
    ├── testapiautoconnect_112862  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112862`
...
2. Clone this repo and `cd testapiautoconnect_112862`
